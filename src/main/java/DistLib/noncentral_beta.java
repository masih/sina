...
public class noncentral_beta {
    ...
    public static double density(double x, double a, double b, double lambda) {
        ...
        /*!* #ifdef IEEE_754 /*4!*/
        if (Double.isNaN(x) || Double.isNaN(a) || Double.isNaN(b) || Double.isNaN(lambda)) return x + a + b + lambda;
        /*!* #endif /*4!*/

        if (lambda < 0 || a <= 0 || b <= 0) { throw new java.lang.ArithmeticException("Math Error: DOMAIN"); }

        /*!* #ifdef IEEE_754 /*4!*/
        if (Double.isInfinite(a) || Double.isInfinite(b) || Double.isInfinite(lambda)) { throw new java.lang.ArithmeticException("Math Error: DOMAIN");
        //    		return Double.NaN;
        }
        /*!* #endif /*4!*/
    ...
    public static double cumulative(double x, double a, double b, double lambda) {
        ...
        if (lambda < zero || a <= zero || b <= zero) { throw new java.lang.ArithmeticException("Math Error: DOMAIN");
        //    	return Double.NaN;
        }
        ...
        if (errbd > errmax) { throw new java.lang.ArithmeticException("Math Error: PRECISION"); }
        return ans;
    }
}
