...
public class t {
    ...
    public static double density(double x, double n) {
        ...
        /*!* #endif /*4!*/
        if (n <= 0.0) { throw new java.lang.ArithmeticException("Math Error: DOMAIN");
        //    	return Double.NaN;
        }
        /*!* #ifdef IEEE_754 /*4!*/
        if (Double.isInfinite(x)) return 0;
        if (Double.isInfinite(n)) return normal.density(x, 0.0, 1.0);
        /*!* #endif /*4!*/
    ...
    public static double cumulative(double x, double n) {
        ...
        /*!* #ifdef IEEE_754 /*4!*/
        if (Double.isInfinite(x)) return (x < 0) ? 0 : 1;
        if (Double.isInfinite(n)) return normal.cumulative(x, 0.0, 1.0);
        /*!* #endif /*4!*/
    ...
    public static double quantile(double p, double ndf) {
        ...
        if (ndf < 1 || p > 1 || p < 0) { throw new java.lang.ArithmeticException("Math Error: DOMAIN");
        //    	    return Double.NaN;
        }
