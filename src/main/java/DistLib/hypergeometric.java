...
public class hypergeometric {
    ...
    */
    ...
    public static double cumulative(double x, double NR, double NB, double n) {
        ...
        if (Double.isInfinite(x) || Double.isInfinite(NR) || Double.isInfinite(NB) || Double.isInfinite(n)) { throw new java.lang.ArithmeticException("Math Error: DOMAIN");
        //    	return Double.NaN;
        }
        /*!* #endif /*4!*/
        ...
        if (NR < 0 || NB < 0 || n < 0 || n > N) { throw new java.lang.ArithmeticException("Math Error: DOMAIN");
        //    	return Double.NaN;
        }
        /*!*     xstart = fmax2(0, n - NB); *!*/
    ...
    public static double density(double x, double NR, double NB, double n) {
        ...
        if (x < Math.max(0, n - NB) || x > Math.min(n, NR)) return 0;
    ...
    public static double quantile(double x, double NR, double NB, double n) {
        ...
        /*!*     n = floor(n + 0.5); *!*/
        n = java.lang.Math.floor(n + 0.5);
        if (x < 0 || x > 1 || NR < 0 || NR < 0 || n < 0 || n > N) { throw new java.lang.ArithmeticException("Math Error: DOMAIN");
        //    	return Double.NaN;
        }
        /*!*     xstart = fmax2(0, n - NB); *!*/
        xstart = Math.max(0, n - NB);
    ...
    public static double random(double nn1in, double nn2in, double kkin, uniform PRNG) {
        ...
        /*!* #ifdef IEEE_754 /*4!*/
        if (Double.isInfinite(nn1in) || Double.isInfinite(nn2in) || Double.isInfinite(kkin)) { throw new java.lang.ArithmeticException("Math Error: DOMAIN");
        //    	return Double.NaN;
        }
        /*!* #endif /*4!*/
        ...
        if (minjx == maxjx) {
            ...
            if (setup1 || setup2) {
                ...
                kl = java.lang.Math.exp(a - afc((int) (xl)) - afc((int) (n1 - xl)) - afc((int) (k - xl)) - afc((int) (n2 - k + xl)));
                /*!* 	    kr = exp(a - afc((int) (xr - 1)) *!*/
                kr = java.lang.Math.exp(a - afc((int) (xr - 1)) - afc((int) (n1 - xr + 1)) - afc((int) (k - xr + 1)) - afc((int) (n2 - k + xr - 1)));
