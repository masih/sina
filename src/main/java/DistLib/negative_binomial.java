...
public class negative_binomial {
    ...
    public static double density(double x, double n, double p) {
        ...
        if (n < 1 || p <= 0 || p >= 1) { throw new java.lang.ArithmeticException("Math Error: DOMAIN");
        //    	return Double.NaN;
        }
        if (x < 0) return 0;
        /*!* #ifdef IEEE_754 /*4!*/
    ...
    public static double quantile(double x, double n, double p) {
        ...
        /*!* #ifdef IEEE_754 /*4!*/
        if (Double.isNaN(x) || Double.isNaN(n) || Double.isNaN(p)) return x + n + p;
        if (Double.isInfinite(x)) { throw new java.lang.ArithmeticException("Math Error: DOMAIN");
        //    	return Double.NaN;
        }
        /*!* #endif /*4!*/
        /*!*     n = floor(n + 0.5); *!*/
    ...
    public static double random(double n, double p, uniform PRNG) {
        ...
        /*!* #endif /*4!*/
        n <= 0 || p <= 0 || p >= 1) { throw new java.lang.ArithmeticException("Math Error: DOMAIN");
        //    	return Double.NaN;
        }
